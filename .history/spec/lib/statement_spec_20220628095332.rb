...
RSpec.describe 'Rental' do
  it 'statement' do
    ...
    customer.add_rental(Rental.new(Movie.new('Filme terror', 0), 1))
    customer.add_rental(Rental.new(Movie.new('Filme humor', 1), 1))
    customer.add_rental(Rental.new(Movie.new('Filme drama', 2), 1))
